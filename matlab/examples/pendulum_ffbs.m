%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Estimate pendulum state with a particle smoother as in Example 15.3 of
% the book
%
...
%
    ...
    fprintf('Doing backward simulation which might take time...\n');
    ...
    set(h,'Linewidth',5);
    fprintf('FFBS estimate.\n');
    legend('Measurements','True','Estimate');
  
    rmse_ffbs = sqrt(mean((X(1,:)-MMS(1,:)).^2))
...
%
    ...
    legend('True angle','Measurements','FFBS estimate');
